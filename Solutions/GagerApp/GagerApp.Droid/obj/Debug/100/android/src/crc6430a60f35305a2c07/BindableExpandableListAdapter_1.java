...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Calcium.UI.Adapters.BindableExpandableListAdapter`1, Calcium.Extras.Platform", BindableExpandableListAdapter_1.class, __md_methods);
	}


	public BindableExpandableListAdapter_1 ()
	{
		super ();
		if (getClass () == BindableExpandableListAdapter_1.class)
			mono.android.TypeManager.Activate ("Calcium.UI.Adapters.BindableExpandableListAdapter`1, Calcium.Extras.Platform", "", this, new java.lang.Object[] {  });
	}
