...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Calcium.GeoLocation.GeoLocator, Calcium.Extras.Platform", GeoLocator.class, __md_methods);
	}
	...
	public GeoLocator ()
	{
		...
		if (getClass () == GeoLocator.class)
			mono.android.TypeManager.Activate ("Calcium.GeoLocation.GeoLocator, Calcium.Extras.Platform", "", this, new java.lang.Object[] {  });
	}
