...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Calcium.Device.Sensors.Accelerometer+SensorListener, Calcium.Extras.Platform", Accelerometer_SensorListener.class, __md_methods);
	}
	...
	public Accelerometer_SensorListener ()
	{
		...
		if (getClass () == Accelerometer_SensorListener.class)
			mono.android.TypeManager.Activate ("Calcium.Device.Sensors.Accelerometer+SensorListener, Calcium.Extras.Platform", "", this, new java.lang.Object[] {  });
	}
