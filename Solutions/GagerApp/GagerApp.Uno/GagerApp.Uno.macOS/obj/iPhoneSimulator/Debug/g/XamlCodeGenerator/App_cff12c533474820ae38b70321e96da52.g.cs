...
namespace GagerApp.Uno
{
	...
	public partial class App : Windows.UI.Xaml.Application
	{
		private void InitializeComponent()
		{
			...
			.Apply((c0 => 
			{
				// Source D:\vs\gager_app\Gager App\Solutions\GagerApp\GagerApp.Uno\GagerApp.Uno.Shared\App.xaml (Line 1:2)
			...
			global::GagerApp.Uno.macOS.GlobalStaticResources.Initialize();
			global::GagerApp.Uno.macOS.GlobalStaticResources.RegisterResourceDictionariesBySourceLocal();
			global::Uno.UI.DataBinding.BindableMetadata.Provider = new global::GagerApp.Uno.macOS.BindableMetadataProvider();
			#if __ANDROID__
			global::Uno.Helpers.DrawableHelper.Drawables = typeof(global::GagerApp.Uno.macOS.Resource.Drawable);
			#endif
			// Source ..\..\..\..\..\..\..\GagerApp.Uno.Shared\App.xaml (Line 1:2)
		}
	}
}
namespace GagerApp.Uno.macOS
{
	static class App_cff12c533474820ae38b70321e96da52XamlApplyExtensions
	{
	}
}
